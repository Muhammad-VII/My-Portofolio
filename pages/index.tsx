  ...
  return (
    <div className="bg-primary/60 h-full">
      ...
      <div className="w-[1200px] h-full absolute right-0 bottom-0">
        {/* bg image */}
        <div className="bg-none 2xl:bg-cover 2xl:bg-no-repeat 2xl:bg-center xl:bg-explosion xl:bg-cover xl:bg-right xl:bg-no-repeat w-full h-full absolute mix-blend-color-dodge translate-z-0"></div>
        {/* particals */}
        <ParticlesContainer />
        {/* avatar */}
        <motion.div
